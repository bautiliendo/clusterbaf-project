                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2">
                        ...
                        <div className="p-6 sm:p-10 bg-gray-50">
                            ...
                            <div className="space-y-6 font-semibold text-xl">
                                ...
                                <div className="flex items-start">
                                    <svg className="w-6 h-6 text-jonquil flex-shrink-0 mt-1.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <div className="flex items-start">
                                    <svg className="w-6 h-6 text-jonquil flex-shrink-0 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
